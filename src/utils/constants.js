...
const VARAINT_OBJECT_COLUMNS = ["unitType", "purchaseUnits", "salesUnits"];
...
const productLabelsToKeys = {
  ...
  Category: "category",
  "Base UoM": "unitType",
  "Base UoM Barcode Type": "unitTypebarcodeType",
  "Base UoM Barcode Value": "unitTypebarcodeValue",
  "Auto generate Base UoM Barcode": "autoGenerateUnitTypeBarcode",
  "Purchase UoM": "purchaseUnits",
  "Purchase UoM C/F": "purchaseUnitsConversionFactor",
  "Purchase UoM C/F Value": "purchaseUnitsConversionFactorValue",
  "Purchase UoM Barcode Type": "purchaseUnitsbarcodeType",
  "Purchase UoM Barcode Value": "purchaseUnitsbarcodeValue",
  "Sale UoM": "salesUnits",
  "Sale UoM C/F": "salesUnitsConversionFactor",
  "Sale UoM C/F Value": "salesUnitsConversionFactorValue",
  "Sale UoM Barcode Type": "salesUnitsbarcodeType",
  "Sale UoM Barcode Value": "salesUnitsbarcodeValue",
...
const productKeysToLabels = Object.fromEntries(
  Object.entries(productLabelsToKeys).map(([label, key]) => [key, label])
);
