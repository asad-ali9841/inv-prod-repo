...
const ProductItemSchema = new Schema({
  ...
  unitTypebarcodeType: {
    ...
    validate: {
      validator: function (value) {
        return VALID_BARCODE_TYPES.includes(value);
      },
      message: "Invalid barcode type",
    },
  },
  unitTypebarcodeValue: { type: String, default: "" },
  purchaseUnits: {
    label: {
      type: String,
      required: function () {
  ...
  purchaseUnitsConversionFactor: {
    type: String,
    enum: Object.values(ConversionFactor),
    required: true,
    default: ConversionFactor.Multiply,
  },
  purchaseUnitsConversionFactorValue: {
    ...
    validate: {
      ...
      message: "Invalid value for conversion factor",
    },
  },
  ...
  purchaseUnitsbarcodeValue: { type: String, default: "" },
  isSameSalesUnit: {
    type: Boolean,
    default: true,
    required: true,
  ...
  salesUnitsbarcodeValue: { type: String, default: "" },
  salesUnits: {
    label: {
      type: String,
      required: function () {
